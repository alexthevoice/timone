...
export const STORICO = [
  [4, "Il menu torna in barra, e arriva la Rubrica: recapiti, note e i task di ognuno"],
  [3, "La lista della Review non si traveste più da pastiglia di priorità: classi separate"],
